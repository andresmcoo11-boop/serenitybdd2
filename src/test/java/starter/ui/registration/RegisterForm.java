...
public class RegisterForm {
    ...
    public static Target SELECT_COUNTRY= Target.the("selec country").locatedBy("//select[@id='country']");
    public static Target INPUT_EMAIL= Target.the("input email").locatedBy("//input[@type='email']");
    public static Target INPUT_SEX= Target.the("input sex").locatedBy("//input[@id='sex-f']");
